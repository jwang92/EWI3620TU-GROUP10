...
class PolygonCanvas extends JPanel {
	private List<PolygonClipper> subjectPolygons = new ArrayList<PolygonClipper>();
	private List<PolygonClipper> clipPolygons = new ArrayList<PolygonClipper>();
	private List<PolygonClipper> solutionPolygons = new ArrayList<PolygonClipper>();
	...
	private void drawPolygons(Graphics2D g, List<PolygonClipper> polygons, Color fill, Color stroke) {
	...
	private void drawShadow(Graphics2D g, List<PolygonClipper> polygons) {
		GeneralPath path = createPath(polygons, 0, 0);
		g.clip(path);
	...
	private GeneralPath createPath(List<PolygonClipper> polygons, int offsetX, int offsetY) {
		GeneralPath path = new GeneralPath();
		
		for(PolygonClipper polygon:polygons) {
	...
	public void setSubjectPolygons(List<PolygonClipper> polygons) {
		this.subjectPolygons = polygons;
		repaint();
	}

	public void setClipPolygons(List<PolygonClipper> polygons) {
		this.clipPolygons = polygons;
		repaint();
	}

	public void setSolutionPolygons(List<PolygonClipper> polygons) {

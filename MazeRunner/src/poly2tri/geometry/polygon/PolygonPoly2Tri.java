...
public class PolygonPoly2Tri implements Triangulatable
{
    ...
    protected ArrayList<PolygonPoly2Tri> _holes;
     ...
     * @param p3
     */
    public PolygonPoly2Tri( PolygonPoint p1, PolygonPoint p2, PolygonPoint p3 )
    {
        p1._next = p2;
        p2._next = p3;
        p3._next = p1;
     ...
     */
    public PolygonPoly2Tri( List<PolygonPoint> points )
    {
     ...
     * @param points
     */
    public PolygonPoly2Tri( PolygonPoint[] points )
    {        
     ...
     */
    public void addHole( PolygonPoly2Tri poly )
    {
        if( _holes == null )
        {
            _holes = new ArrayList<PolygonPoly2Tri>();
        }
        _holes.add( poly );

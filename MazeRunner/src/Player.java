...
public class Player extends GameObject {	
	...
	private double newverAngle, newX, newZ;
	...
	public void update(int deltaTime)
	{
		if (control != null)
		{
			...
			horAngle = horAngle + control.getdX() * speed/3.0;
			newverAngle = verAngle + control.getdY() * speed/3.0;
			if(-45 <= newverAngle && newverAngle <= 45)
				verAngle = newverAngle;

...
public class RightArm extends GameObject implements VisibleObject {										
	...
	public RightArm(double x, double y, double z,boolean tex, String modelName, MainClass mclass, boolean groot){
		super(x, y, z, mclass);
		texture = tex;
	...
	public void update(int deltaTime, Player player){
		...
		// booleaan forward: if Rightarm moves forward then leftarm must move backward

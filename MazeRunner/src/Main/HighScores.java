...
//	}
	...
	public void drawScoreBg(GL gl){
		...
		gl.glBegin(GL.GL_QUADS);
			gl.glVertex2f(200, 20);
			gl.glVertex2f(200, 480);
			gl.glVertex2f(580, 480);
			gl.glVertex2f(580, 20);
		gl.glEnd();
	...
	public void drawScores(GL gl){
		...
		for(int i = 1; i <= scores.size(); i++){
			...
			t.draw(i + ".", (int) (ScreenWidth * 0.35f), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Nummer
			t.draw(scores.get(i-1)[0], (int) (ScreenWidth * 0.35f + fontSize * 3), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Naam
			t.draw(""+scores.get(i-1)[1], (int) (ScreenWidth * 0.35f + fontSize * 20), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Scores	
			t.draw(scores.get(i-1)[2], (int) (ScreenWidth * 0.35f + fontSize * 25), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Level	
		...
		for(int i = 1; i < 21; i++){
			...
			t.draw(i + ".", (int) (ScreenWidth * 0.35f), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Nummer
			t.draw("Bertvanderven123", (int) (ScreenWidth * 0.35f + fontSize * 3), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Naam
			t.draw(""+(100 * i), (int) (ScreenWidth * 0.35f + fontSize * 20), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Scores	
			t.draw("Kasteel", (int) (ScreenWidth * 0.35f + fontSize * 25), (int) (ScreenHeight * 0.75f - (i * fontSize))); // Level	
